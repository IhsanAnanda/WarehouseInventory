...
@EnableKafka
@Configuration
public class GetOrderByQtyConsumer {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, OrderDTO.Request>> getOrderByQtyKafkaListenerContainerFactory() {
