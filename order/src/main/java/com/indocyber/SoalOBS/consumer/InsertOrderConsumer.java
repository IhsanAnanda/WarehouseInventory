...
@EnableKafka
@Configuration
public class InsertOrderConsumer {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, OrderDTO.Request>> insertOrderKafkaListenerContainerFactory() {
