...
@Configuration
public class DeleteInventoryByIdKafkaProducer {
    ...
    @Bean
    public ReplyingKafkaTemplate<String, GetInventoryDTO.Request, String> deleteInventoryByItemIdmRequestReplyKafkaTemplate(
