...
@Configuration
public class GetInventoryKafkaProducer {
    ...
    @Bean
    public ReplyingKafkaTemplate<String, GetInventoryDTO.Request, String> getInventoryByItemIdmRequestReplyKafkaTemplate(
